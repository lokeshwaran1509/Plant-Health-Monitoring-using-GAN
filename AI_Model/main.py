...
# Dataset path
dataset_path = r"C:\Users\Lokeshwaran\Documents\plant_disease_detection\plant_disease\dataset\train"  # Main folder containing vegetable folders
...
def generate_synthetic_data(generator, num_samples, z_dim):
    noise = np.random.normal(0, 1, (num_samples, z_dim))
    synthetic_images = generator.predict(noise)
    return synthetic_images

num_synthetic_samples = 100
synthetic_images = generate_synthetic_data(generator, num_synthetic_samples, Z_DIM)
...
# Save model
classifier.save("plant_disease_model.keras")
...
print("Model conversion complete! TFLite model saved as plant_disease_model.tflite")
